...
def test_routine_calls(stack: ZMachineStack):
    ...
    stack.push_routine_call(ret_a, len(a_locals), *a_locals)
    ...
    assert stack.pop_routine_call() == ret_a
